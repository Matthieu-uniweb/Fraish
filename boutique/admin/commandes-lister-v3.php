...
for ($i=0; $i<count($nom); $i++)
    ...
    <td width="25%" valign="top" height="400" style="border: 1px dashed #000000; padding: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top"><h3><?php echo utf8_decode($nom[$i]); ?> <?php echo utf8_decode($prenom[$i]); ?></h3></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="top"><h4 <?php if (strlen($soupe[$i]) > 0 ) echo "class='typesoupe' " ;?>><?php echo $soupe[$i]; ?></h4></td>
        </tr>
        <?php 
		} //FIN afficher soupe
		...
		if($plat[$i])//IF afficher salade
            ...
            <tr>
              <td valign="top"><h4 <?php if (strlen($vinaigrette[$i]) > 0 ) echo "class='typeproduit' " ;?>><?php echo $vinaigrette[$i]; ?></h4>
			  </td>
            </tr>
            <?php 
		...
		?>
            <tr>
              <td valign="top"><?php /*echo $Tbq_ingredient->libelle;*/ echo stripslashes(stripslashes($libPlat));?></td>
            </tr>
        <?php 
		  ...
		  if ($dessert[$i]) { 
		  	echo "<H4>Dessert</h4> ";?>
            <span style='background-color:#FFFF00;'><?php echo stripslashes($dessert[$i]);?></span><?php
			} ?></td>
            <?php
			}?>
        <tr>
          <td valign="top"><h4>Pain: <?php echo stripslashes($pain[$i]); ?></h4></td>
        </tr>
        <?php
		if($eau[$i])
			{?>
			<tr>
	            <td valign="top">
                <h4>Eau : <?php echo stripslashes($eau[$i]); ?></h4>
                </td>
			</tr><?php
			}
	...
	if($boisson[$i]=='DailyJuice')
		...
		if($supplements[$i])
			...
			<tr>
				<td><span style='background-color:#2ECCFA;'><?php echo stripslashes($supplements[$i]);?></span></td>
        ...
        <tr>
		  ...
		  if ($commentaire[$i]) { 
		  	echo "Commentaire: ";?>
            <span style='background-color:#FAAC58;'><?php echo $commentaire[$i];?></span><?php
			} ?></td>
        </tr>
        <tr>
        	<td valign="top">
