  ...
  for( $y = $anneeDebut; $y <= $anneeCourante; $y++)
  {
	 ...
	 for( $m = 1; $m <= 12; $m++)
	 {
		...
		$tab[$y][$m] = $commandesMois['somme'];
		 ...
		 <span class="montantCommande"><?php echo number_format($commandesMois['somme'], 0,',',' ');?> &euro;</span><br/><span class="nbCommande"><?php echo $commandesMois['nb'];?></span><br/><span class="panierMoyen"><?php if($commandesMois['nb'] == 0){ echo '0';}else{ echo number_format($commandesMois['somme'] / $commandesMois['nb'], 2,',',' ');}?> &euro;</span></td><?php
	 }
...
<span class="montantCommande"><?php echo number_format($montantCommandesAnnee, 0,',',' ');?> &euro;</span><br/><span class="nbCommande"><?php echo $nbCommandesAnnee;?></span><br/><span class="panierMoyen"><?php if($nbCommandesAnnee == 0){ echo '0';}else{ echo number_format($montantCommandesAnnee / $nbCommandesAnnee, 2,',',' ');}?> &euro;</span></td>
	 </tr><?php
  }?>
