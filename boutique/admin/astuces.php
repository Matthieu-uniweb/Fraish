...
if($_POST['fonction']=='valider')
	{
	$astuce->enregistrer($_POST['content']);
	header('Location:astuces.php');
	}
?>
...
<script src="/boutique/includes/plugins/ckeditor/ckeditor.js"></script>
<script>
...
<div id="page">
  ...
  <div id="contenu"> <!-- InstanceBeginEditable name="contenu" -->
   ...
   <br/><br/>
    ...
    <textarea name="content"><?php echo $astuce->content;?></textarea>
