      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:none;">
        <tr>
               ...
               ?>
                  ...
                  <tr style="display:none" class="contenu jour<?php echo $index; ?>">
                    <td width="99%" style="padding:0px;" colspan="2">
                    	...
                    	<li style="list-style:none; font-size:10px; padding:0px;"><input id="ingredient<?php echo $index.'-'.$soupe['ID']; ?>" <?php echo $checked; ?> type="checkbox" name="soupe[<?php echo $dates[$jour]; ?>][ingredients][]" value="<?php echo $soupe['ID'] ?>"/>&nbsp;<?php echo $soupe['libelle'] ?></li>
         ...
         <tr>
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les crudités du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Crudités');
			  $legumesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Crudités');
              $index = 0;
              foreach ($jours as $jour){
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les salades du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Salades');
			  $feculentSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Salades');
              $index = 0;
              foreach ($jours as $jour){
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
			  ...
			  $grainesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Féculents');
              $index = 0;
              foreach ($jours as $jour){
  		...
  		<tr>
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les fromages du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Fromages');
			  $legumesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Fromages');
              $index = 0;
              foreach ($jours as $jour){
				  //legumes enregistrés dans la base de données mis dans un tableau
				  $legumesEnBase = explode('|',$salade[$dates[$jour]]['ingredients']);
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les viandes du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Viandes');
			  $legumesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Viandes');
              $index = 0;
              foreach ($jours as $jour){
				  //legumes enregistrés dans la base de données mis dans un tableau
				  $legumesEnBase = explode('|',$salade[$dates[$jour]]['ingredients']);
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les poissons du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Poissons');
			  $legumesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Poissons');
              $index = 0;
              foreach ($jours as $jour){
				  //legumes enregistrés dans la base de données mis dans un tableau
				  $legumesEnBase = explode('|',$salade[$dates[$jour]]['ingredients']);
  		...
  		<tr>
            ...
            <td valign="top" style="border:solid 1px #000;"><table width="100%"  style="border:none" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2"><h2>Les topping du jour</h2></td>
              </tr>
			  <?php
			  $defaultChecked = Tbq_ingredient::getDefaultStuff($ID_familles['salade'],'Topping');
			  $legumesSalade = Tbq_famille::listerIngredients($ID_familles['salade'], 'libelleSousFamille DESC', 'Topping');
              $index = 0;
              foreach ($jours as $jour){
				  //legumes enregistrés dans la base de données mis dans un tableau
				  $legumesEnBase = explode('|',$salade[$dates[$jour]]['ingredients']);
