...
<div id="page">
 <div id="contenu">
   ...
   <h1>Annulation de la commande CB</h1>
<h3>La commande n&deg;<? echo $commande[0]['ID_commande_fraish']; ?> pay&eacute;e par Carte Bancaire a &eacute;t&eacute; annul&eacute;e.</h3>
<p><strong>Identifiant de commande : </strong><?php echo $commande[0]['ID'];?></p>
<p><strong>Montant : </strong><?php echo $commande[0]['prix'];?> &euro;</p>
<p><strong>Client : </strong><?php echo $client->nomFacturation.' '.$client->prenomFacturation;?></p>
