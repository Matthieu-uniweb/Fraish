...
?>
<form method="post" id="formulaireHeure" name="formulaireHeure" action="" onsubmit="">

<?php /*?><h2>Choisissez votre formule</h2><?php */?>
<?php include rtrim($_SERVER['DOCUMENT_ROOT'],'/').'/Library/detail-menus.php';?>
<p style="height:50px;"><a href="javascript:history.go(-1);" class="boutonRetour">&lt; Retour</a></p>
</form>
