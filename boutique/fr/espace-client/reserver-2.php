...
<div id="choixPointDeVente" <? if (isset($_POST['dateReservation'])) { echo 'disabled="disabled" style="display:none"'; }?>>
      ...
      <p><select name="ID_pointDeVente"><?php foreach ($pointsDeVente as $point) { ?><option value="<?php echo $point->ID;?>" <?php if ($favori->ID_pointDeVente==$point->ID) { echo 'selected="selected"'; } ?>><?php echo $point->pointDeVente;?></option><?php } ?></select>
      </p>
      <p><em>Commandes par internet prochainement disponibles <br />
      pour votre FRAISH 40 rue des Filatiers &agrave; Toulouse</em></p>
    </div>
<p>
