...
<?php /*?><a href="javascript:accederPaiementCB();" title="Paiement carte bancaire" style="font-size:18px; font-weight:bold; padding-left:0px; text-decoration:none;"><?php */?>Je paie par carte bancaire<?php /*?></a><?php */?></h3>
<div style="border:solid 2px #93C6FF; width:550px; padding-left:35px;">
Le paiement sécurisé est actuellement indisponible.
<?php /*?><p>
<form action="/includes/paiement/call_request.php" method="post">
</form>
...
Nous utilisons le système <strong>CyberPlus</strong> de la <strong>Banque Populaire</strong>.</p><?php */?>
</div>
...
<?php /*?><a href="javascript:accederPaiementCompteCredit('paiementEspeces');" title="Créditer mon compte client"><img src="/boutique/images/paiement-especes.jpg" /></a><?php */?>
    ...
    <?php /*?><p style="text-align:justify;"><img src="/images/site/titre-paiement-cb.jpg" width="115" /><br />Vous pouvez payer juste la somme de votre menu du jour en ligne avec CB.</p><?php */?>
