<?php
 /* // Fonction pour afficher le calendrier
     function showCalendar($periode) {
          ...
          $leCalendrier .= "\n\t<h2><a href=\"javascript:PrevMonth(". getMonth($periode) .")\">&lt;</a> " . monthNumToName(getMonth($periode)) . " " . getYear($periode) . "<a href=\"javascript:NextMonth(". getMonth($periode) .")\">&gt;</a>" . "</h2>";
          ...
          while ($pas < $nb_jour) {
               ...
               if (Date("w", mktime(0, 0, 0, getMonth($periode), 1 + $pas, getYear($periode))) == $tableau[$indexe]) {
                    ...
                    $afficheJour = "<a href=\"javascript:actualiseJour(". Date("j", mktime(0, 0, 0, getMonth($periode), 1 + $pas, getYear($periode))) .")\">" . Date("j", mktime(0, 0, 0, getMonth($periode), 1 + $pas, getYear($periode))) . "</a>";
