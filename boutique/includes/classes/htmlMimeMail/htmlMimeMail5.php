    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        $this->is_built      = false;
        $this->text          = '';
        /*if(is_file('/usr/local/httpd/php-tools/sendmail')){
            $this->sendmail_path = '/usr/local/httpd/php-tools/sendmail -ti';
        } else {*/
        ...
        */
		...
		//$this->smtp_params['host'] = '80.247.235.90';
		//$this->smtp_params['host'] = '194.116.144.30';
        $this->smtp_params['port'] = 25;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = false;
        $this->smtp_params['user'] = '';
        $this->smtp_params['pass'] = '';
        //var_dump($this->smtp_params, $this->sendmail_path);die;
