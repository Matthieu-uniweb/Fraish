...
tinyMCE.importPluginLanguagePack('simplebrowser');
...
var TinyMCE_SimpleBrowserPlugin = {
	...
	browserCallback : function(returnValue) {
		...
		/* Modifié Par Adrien */
		TinyMCE_SimpleBrowserPlugin.options['target'].document.forms[0].elements[TinyMCE_SimpleBrowserPlugin.options['field']].onchange();
	}
};
