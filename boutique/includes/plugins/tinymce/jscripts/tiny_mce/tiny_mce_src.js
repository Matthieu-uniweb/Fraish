...
TinyMCE_Engine.prototype = {
	...
	setupContent : function(editor_id) {
		...
		/* Modifié Par Adrien : fonctionnalité ajoutée */
		if (tinyMCE.getParam("style_body",false))
			doc.body.setAttribute('class', doc.body.className+' '+tinyMCE.getParam("style_body"));
