...
<div id="globalbox">
	...
	<div id="boxright">
		...
		<br /><br />
		<form name="inscription" method="post"  enctype="multipart/form-data" id="forminscription">	
		...
		<br />
		<button type="submit" class="btnfleche" style="cursor: pointer;">
			Créer mon compte
		</button>
