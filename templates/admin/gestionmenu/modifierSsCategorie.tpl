...
{	
	if (document.formulaire.titre.value==''){
		alert ('Vous devez saisir le titre de la nouvelle sous catégorie');
		return false;
	}
...
Saisissez le nouveau titre de la sous catégorie :<br />
...
<input type="hidden" name="fonction" value="traiterModifierSsCategorie">
</form>
