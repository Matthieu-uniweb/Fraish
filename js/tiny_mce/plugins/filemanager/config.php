<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../media/up/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../media/up/'; // absolute or relative from this script path.
