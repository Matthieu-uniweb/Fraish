<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../media/up/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../media/up/'; // absolute or relative from this script path, required.
