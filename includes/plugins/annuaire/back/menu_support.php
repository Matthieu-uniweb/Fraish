   ...
   <table width="562" border="0" cellpadding="1" cellspacing="0" bgcolor="#D4D4D4">
    <tr>
     <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
       <tr>
        <td bgcolor="#D9DCEE" class="titre"><img src="../images/back/fleche_titre.gif" width="22" height="18" align="absmiddle">Vos supports de diffusion </td>
       </tr>
       <tr>
       ...
       <tr>
        <td bgcolor="#EDEDED"><b><img src="../images/e.gif" width="30" height="17" align="absmiddle"><span class="texte">Supports utilisant l'annuaire en temps r&eacute;el :</span></b> </td>
       </tr>
       <tr>
        <td><img src="../images/e.gif" width="1" height="15"></td>
       </tr>
       <form name="formulaire" method="post" action="saisir_support.php">
        <tr>
         <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
           <tr>
            <td width="50"><img src="../images/e.gif" width="30" height="17" align="absmiddle"></td>
            <td width="99%"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <?
						...
						for ($i=0; $i<count($supports); $i++)
							{ ?>
              <tr>
               <td width="250" nowrap><b><span class="texte">&gt; <? echo $supports[$i]['libelle']; ?></span></b></td>
							 <td width="75" nowrap>&raquo;&nbsp; <a href="javascript:;" onClick="consulterSupport('<? echo $supports[$i]['ID']; ?>');return false;" class="textecourant">Consulter</a></td>
               <td width="75" nowrap>&raquo;&nbsp; <a href="javascript:;" onClick="support('<? echo $supports[$i]['ID']; ?>');return false;" class="textecourant">Modifier</a></td>
               <td width="75" nowrap>&raquo;&nbsp; <a href="javascript:;" onClick="if (confirm('Etes-vous sûr de vouloir supprimer ce support ? \nAttention ceci supprimera également toutes les catégories de ce support !!')) { supprimerSupport('<? echo $supports[$i]['ID']; ?>');return false; }" class="textecourant">Supprimer</a></td>
              </tr>
              <? } ?>
             </table></td>
           </tr>
        ...
        <input type="hidden" name="ID_support_a_modifier">
