    ...
    <table width="562" border="0" cellpadding="1" cellspacing="0" bgcolor="#D4D4D4">
     <tr>
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
         <td bgcolor="#D9DCEE" class="titre"><img src="../images/back/fleche_titre.gif" width="22" height="18" align="absmiddle">Gestion des supports</td>
        </tr>
        <tr>
         ...
         <td><table width="100%" border="0" cellpadding="0" cellspacing="5" bordercolor="#000000" bgcolor="#898DB0">
           <tr>
            <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
               <td nowrap class="menuHaut"><b>Libell&eacute; : </b></td>
               <td width="99%" class="menuHaut">&nbsp;&nbsp;<? echo $support->libelle; ?></td>
              </tr>
             </table></td>
           </tr>
          </table></td>
          ...
          <table width="100%" border="0" align="center" cellpadding="5">
           <? 
						for ($i=0; $i<$_POST['catMere']; $i++)
							{	?>
           <tr>
            <td class="texte">Libellé :
             <input type="text" name="categorie[<? echo $i; ?>][libelle]" class="input150">
&nbsp;&nbsp;&nbsp; Ordre :
             <input type="text" name="categorie[<? echo $i; ?>][ordre]" class="input50" value="<? echo $i+1; ?>" onKeyPress="return verifierSaisieChiffres();"></td>
           </tr>
           <? } ?>
           <tr>
            <td align="right"><input name="executer" type="button" class="bouton" onClick="ajouterCategorie();" value="Exécuter >>"></td>
           </tr>
          </table>
          <? } ?>
         </td>
    ...
    <input type="hidden" name="catMere" value="<? echo $_POST['catMere']; ?>">
