 ...
 <tr>
  ...
  <td width="562" valign="top"><!-- InstanceBeginEditable name="contenu" -->
   <table width="562" border="0" cellspacing="0" cellpadding="0">
    <tr>
     <td align="center"><img src="../images/back/bienvenue.gif" width="381" height="199"></td>
    </tr>
    <tr>
     <td><img src="../images/e.gif" width="562" height="21"></td>
    </tr>
    <tr>
   ...
   <table width="562" border="0" cellpadding="1" cellspacing="0" bgcolor="#D4D4D4">
    <tr>
     <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
       <tr>
        <td bgcolor="#D9DCEE" class="titre"><img src="../images/back/fleche_titre.gif" width="22" height="18" align="absmiddle">Informations g&eacute;n&eacute;rales sur votre annuaire</td>
       </tr>
       <tr>
       ...
       <tr>
        <td bgcolor="#EDEDED"><b><img src="../images/e.gif" width="50" height="17" align="absmiddle"><span class="texte">Structures r&eacute;pertori&eacute;es :</span> <span class="menu"><? echo count($listeStructures); ?></span></b> </td>
       </tr>
       <tr>
