...
if ($_POST['enregistrerCategorieService'])
	{
	// Liaison aux catégories
	$categorie->lierServiceCategories($_POST);
	}

switch ($_POST['operation'])
	{
	// Recherche selon le nom de la structure, ou son code
	case 'listerStructure':
		$objet = new Tannuaire_structure_recherche();
		$listeStructures = $objet->rechercherStructureCriteres($_POST);
		break;
	// Recherche selon un ID catégorie
...
$options .= 'lierStructure,avecContact';
$tabOptions=array();
?>
...
function checkAll(on)
	...
	for (i=0;i<document.formulaire.elements.length;i++)
		...
		if (document.formulaire.elements[i].type=="checkbox")
			{
			document.formulaire.elements[i].checked=on;
			}
		}
	}
</script>
     ...
     <tr> 
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> 
         ...
         <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> 
           ...
           <tr> 
            <td bgcolor="#EDEDED"><b><img src="../images/e.gif" width="50" height="17" align="absmiddle"><span class="texte">Nom
               du support :</span> <span class="menu"><? echo $support->libelle; ?></span></b> </td> 
           </tr> 
           <tr> 
            <td bgcolor="#EDEDED"><b><img src="../images/e.gif" width="50" height="17" align="absmiddle"><span class="texte">Nom
               de la cat&eacute;gorie :</span> <span class="menu"><? echo $categorie->libelle; ?></span></b> </td> 
           </tr> 
           <tr> 
        ...
        <tr> 
         <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> 
           <tr> 
            <td align="center"><!-- #BeginLibraryItem "/includes/plugins/annuaire/back/modeles/annuaire_back_criteres_support.lbi" -->
             <?
if ($options)
	{
              ...
              <tr>
               <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                  ...
                  <td valign="middle" nowrap><a href="javascript:;" onClick="lierServices('<? echo $categorie->ID; ?>');return false;" class="textecourant"><img src="../images/back/f_bleu.gif" width="16" height="12" hspace="2" border="0" align="absmiddle">Autre
                    recherche</a></td>
                 </tr>
               </table></td>
              </tr>
...
?>
            ...
            <table width="95%" border="0" cellpadding="1" cellspacing="0"> 
              <tr> 
               <td width="95%" align="right" class="texte"><a href="javascript:checkAll(true);" class="pied">Tout
                 s&eacute;lectionner</a> / <a href="javascript:checkAll(false);" class="pied">Tout
                 d&eacute;s&eacute;lectionner</a> </td> 
              </tr> 
              <tr> 
               <td><img src="../images/e.gif" width="1" height="20"></td> 
              </tr> 
              <tr> 
               <td align="right"><input type="submit" name="Lier" value="Lier à la catégorie" class="bouton"></td> 
              </tr> 
              <tr> 
               <td><img src="../images/e.gif" width="1" height="20"></td> 
              </tr> 
              <tr> 
               <td align="right"><a href="javascript:;" onClick="document.formAction.submit(); return false;" class="pied">Revenir au support</a></td> 
              </tr> 
              <tr> 
               <td><img src="../images/e.gif" width="1" height="20"></td> 
              </tr> 
    ...
    <input type="hidden" name="enregistrerCategorieService" value="1"> 
   </form> 
