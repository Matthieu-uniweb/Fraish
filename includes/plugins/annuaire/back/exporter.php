...
switch ($_POST['fonction'])
	{
	case 'exporterStructure':
		$nomFichier = dirname(__FILE__).'/../../../../uploads/structures.csv';
		if (file_exists($nomFichier))
			{
			unlink($nomFichier);
			}
		$structure = new Tannuaire_structure();
		$structure->exporter($nomFichier);
		header("Location: download.php?fic=structures.csv");
		break;
	case 'exporterService':
		$nomFichier = dirname(__FILE__).'/../../../../uploads/services.csv';
		if (file_exists($nomFichier))
			{
			unlink($nomFichier);
			}
		$service = new Tannuaire_service();
		$service->exporter($nomFichier);
		header("Location: download.php?fic=services.csv");
		break;
	case 'exporterContact':
		$nomFichier = dirname(__FILE__).'/../../../../uploads/contacts.csv';
		if (file_exists($nomFichier))
			{
			unlink($nomFichier);
			}
		$contact = new Tannuaire_contact();
		$contact->exporter($nomFichier);
		header("Location: download.php?fic=contacts.csv");
		break;
	}
?>
...
function exporter(type)
	{
	document.forms[0].fonction.value = 'exporter'+type;
   ...
   <table width="562" border="0" cellpadding="1" cellspacing="0" bgcolor="#D4D4D4">
    <tr>
     <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
       <tr>
        <td bgcolor="#D9DCEE" class="titre"><img src="../images/back/fleche_titre.gif" width="22" height="18" align="absmiddle">Exportation</td>
       </tr>
       <tr>
       ...
       <tr>
        <td bgcolor="#EDEDED"><b><img src="../images/e.gif" width="50" height="17" align="absmiddle"><span class="texte"><a href="javascript:;" onClick="exporter('Structure');return false;" class="textecourant">Exportation des structures</a></span></b></td>
       </tr>
       <tr>
        <td><b><img src="../images/e.gif" width="50" height="17" align="absmiddle"><span class="texte"><a href="javascript:;" onClick="exporter('Service');return false;" class="textecourant">Exportation des services</a></span></b></td>
       </tr>
       <tr>
        <td bgcolor="#EDEDED"><img src="../images/e.gif" width="50" height="17" align="absmiddle"><b><span class="texte"><a href="javascript:;" onClick="exporter('Contact');return false;" class="textecourant">Exportation des contacts</a></span></b></td>
       </tr>
       <tr>
        <td><img src="../images/e.gif" width="560" height="20"></td>
       </tr>
