...
var divAffiche = '';
function afficherSupport(numero)
	{
	if (divAffiche != null)
		{
		divAffiche.className = 'divInvisible';
		}
	objetDiv = findObj('support'+numero.toString());
 ...
 <tr> 
  ...
  <td width="562" valign="top"><!-- InstanceBeginEditable name="contenu" --> 
   <form name="formulaire" method="post" action=""> 
    ...
    <table width="562" border="0" cellpadding="1" cellspacing="0" bgcolor="#D4D4D4"> 
     <tr> 
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> 
        <tr> 
         <td bgcolor="#D9DCEE" class="titre"><img src="../images/back/fleche_titre.gif" width="22" height="18" align="absmiddle">Catégories
          et thèmes</td> 
        </tr> 
        <tr> 
        ...
        <tr> 
         <td><table width="100%"  border="0" cellspacing="0" cellpadding="5"> 
           <tr> 
            <td class="texte"><strong>Listes des supports :</strong><br> 
             <?
													for ($i=0; $i<count($supports); $i++)
														{ ?> 
             <a href="javascript:;" onClick="afficherSupport('<? echo $i; ?>');return false;" class="texte"> 
             <?
														echo $supports[$i]['libelle'].'<br>';
														?> 
             </a> 
           ...
           <tr> 
            <td valign="top" width="100%" bgcolor="#898DB0"><table width="100%" border="0" cellspacing="0" cellpadding="5"> 
              <?
														for ($i=0; $i<count($supports); $i++)
															{ ?> 
              <tr> 
               <td><div id="support<? echo $i; ?>" class="divInvisible"> 
                 <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                  <tr> 
                   <td class="texte"><b> 
                    <?
																				echo $supports[$i]['libelle']; ?> 
                    </b></td> 
                  </tr> 
                  <tr> 
                   <td><?
																			$support = new Tannuaire_support($supports[$i]['ID']);
																			echo $support->genererHtmlBack('', '#97AED5', 'categories', $service->ID, $supports[$i]['ID'], 1);
																			?></td> 
                  </tr> 
                 </table> 
                </div></td> 
    ...
    <input type="hidden" name="fonction" value="enregistrerStructureSupport"> 
   </form> 
