...
$_POST['ID_support'] = '1';
$_POST['ID_categorie_consulte'] = '285,1,3,4,5,6';

if (isset($_GET['ID_support']))
	{ $_POST = $_GET; }

$_POST['options']="unePage,trierParCategorie,afficherImage,avecContact,avecAdresseDuContact,afficherComInterne";
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <td width="99%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
      <td><img src="../images/e.gif" width="1" height="7"></td>
     </tr>
     <tr>
      <td align="right"><a href="javascript:;" onClick="printAll();return false;"><img src="../images/front/imprimer.gif" width="17" height="12" border="0"></a></td>
     </tr>
     <tr>
      <td><img src="../images/e.gif" width="1" height="5"></td>
     </tr>
     <tr>
      <td><!-- #BeginLibraryItem "/includes/plugins/annuaire/front/modeles/annuaire_front.lbi" -->
        <?
$categorieEnCours = '';
