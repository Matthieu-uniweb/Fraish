...
<title>Support de diffusion complet</title>
...
for ($t=0; $t<count($tab); $t++)
	...
	if ($tab[$t]['nbFille'] != 0)
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" class="categorieResultats"><img src="../images/e.gif" width="5" height="1"><img src="../images/front/puce_categorie.gif" width="15" height="20" align="absmiddle"> &nbsp;<b><? echo $tab[$t]['libelle'].'<br>'; ?></b></td>
			</tr>
		</table>
<br>		
		<? }
