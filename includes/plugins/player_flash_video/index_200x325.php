...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" name="myflash" width="294" height="328" id="myflash">
  <param name="movie" value="player.swf?nomFichierVideoDepuisInternet=<? echo $nomvideo?>">
  <param name="quality" value="high"><param name="SCALE" value="exactfit">
  <embed src="player.swf?nomFichierVideoDepuisInternet=<? echo $nomvideo ?>" width="294" height="328" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" scale="exactfit" name="myflash" swLiveConnect="true"></embed></object>
<script language="JavaScript" type="text/JavaScript">
if ( MM_FlashCanPlay )
{
