...
<body bgcolor="#FFFFFF" onLoad="MM_preloadImages('/images/imprimer_rollOver.jpg')">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#0066CC">
          ...
          <td height="50" valign="top"> 
            <div align="right">
              <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td width="26%" align="left">&nbsp;<a href="../../aide/index.php"><img src="images/bouton_home.gif" width="53" height="53" border="0" align="absmiddle" alt="Retour à l'accueil et aux autres rubriques de l'Aide"></a>&nbsp;</td>
      ...
      <table width="98%" border="0" cellspacing="8" cellpadding="0">
        ...
        <tr> 
          <td width="33%" align="center" valign="top"> <table width="250" height="206" border="1" cellpadding="2" cellspacing="0" bordercolor="#0066CC" background="../../aide/images/point_interrogation_petit.gif">
              <tr> 
                <td height="12" valign="top" bgcolor="#0066CC"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;<img src="images/etoile_blanche.gif" width="17" height="16" align="absmiddle"> 
                  Rubriques:</strong></font></td>
              </tr>
              <tr> 
                <td valign="top"><?
											include_once ("../../../../includes/classes/objet_class.php");
											include_once (Tobjet::getCheminRacine ()."includes/plugins/moteur_recherche/includes/classes/laetis_moteur_recherche_class.php"); 
											$cheminFichier=Tobjet::getCheminRacine ().TmoteurRecherche::getCheminPlugin();
											include ($cheminFichier."/aide/laetis_menu_aide.php");
            ...
            <br> 
            <table width="250" border="1" cellpadding="1" cellspacing="0" bordercolor="#0066CC" background="images/point_interrogation_petit.gif">
              <tr> 
                <td height="12" valign="top" bgcolor="#0066CC"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;<img src="images/etoile_blanche.gif" width="17" height="16" align="absmiddle"> 
              ...
              <tr> 
                <td valign="top"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br>
                    ...
                    <tr> 
                      <td width="9%" height="21" align="center" valign="middle"><img src="images/carre_plus.gif"></td>
                      <td width="91%"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Un 
                        PC avec Windows</font></td>
                    </tr>
                    <tr> 
                      <td align="center" valign="middle"><img src="images/carre_plus.gif"></td>
                    ...
                    <tr> 
                      <td height="22" align="center" valign="middle"><img src="images/carre_plus.gif"></td>
                    ...
                    <tr> 
                      <td height="22" align="center" valign="middle"><img src="images/carre_plus.gif"></td>
                      <td><a href="../../aide/configuration_poste.php" class="lien">Comment 
    ...
    Les mots de moins de 3 lettres ne sont pas interpr&eacute;t&eacute;s.</p>
        ...
        <tr> 
          <td align="center"><a href="javascript:window.print();" onMouseOver="MM_swapImage('Image1','','../../aide/images/imprimer_rollOver.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="images/imprimer.jpg" alt="imprimer" name="Image1" width="29" height="16" border="0" align="absmiddle" id="Image1"><font class="lien"> 
            imprimer</font></a>&nbsp;</td>
          <td valign="top">&nbsp; </td>
        </tr>
      </table>
