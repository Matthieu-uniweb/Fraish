...
$VADS_CTX_MODE="TEST";//valeur "TEST"
$VADS_CURRENCY="978";
...
$VADS_EFFECTUE = 'http://'.$_SERVER['HTTP_HOST']."/maroquinerie/fr/paiement-cb.php";
$VADS_URL_CANCEL = 'http://'.$_SERVER['HTTP_HOST']."/maroquinerie/fr/paiement-annule.php";
$VADS_REFUSE = 'http://'.$_SERVER['HTTP_HOST']."/maroquinerie/fr/paiement-refuse.php";
$VADS_ERREUR = 'http://'.$_SERVER['HTTP_HOST']."/maroquinerie/fr/paiement-refuse.php";
$VADS_VERSION = "V2";
?>
<html>
<head>
